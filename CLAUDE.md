...
| `unity-catalog-client-api`       | `unity-catalog-client-api/`        | Unity Catalog client traits and shared models           |
| `unity-catalog-client-rest-impl` | `unity-catalog-client-rest-impl/`  | Unity Catalog REST client                               |
