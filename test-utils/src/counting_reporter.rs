...
impl CountingReporter {
    ...
    pub fn print_summary(&self, label: &str) {
        ...
        let crc_calls = self.crc_read_calls.load(Ordering::Relaxed);
        let crc_kib = self.crc_bytes_read.load(Ordering::Relaxed) / 1024;
