...
/// Shape of a Delta table's `_delta_log/` directory along two axes:
///
...
/// - `last_checkpoint_hint` overrides: forcing the `_last_checkpoint` hint to be missing or stale
///   (separate PR).
...
impl LogState {
    ...
    /// `1..n` contain data. No checkpoints by default.
