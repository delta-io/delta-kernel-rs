...
/// Per the Delta protocol, `catalogManaged` depends on `inCommitTimestamp` and
/// `vacuumProtocolCheck`, and commitInfo must include a `txnId`.
...
{"protocol":{"minReaderVersion":3,"minWriterVersion":7,"readerFeatures":["catalogManaged","vacuumProtocolCheck"],"writerFeatures":["catalogManaged","inCommitTimestamp","vacuumProtocolCheck"]}}
