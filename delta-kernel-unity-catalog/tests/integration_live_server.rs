...
///
/// This mutates the catalog, so it is double-gated: requires `UC_CREATE=1`. Uses a fixed table name
/// and best-effort DELETEs before and after to keep reruns idempotent.
#[tokio::test(flavor = "multi_thread")]
