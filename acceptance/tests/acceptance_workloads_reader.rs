...
use delta_kernel_benchmarks::models::{ReadExpected, SnapshotExpected, Spec, TimeTravel};
...
const EXPECTED_KERNEL_FAILURES: &[(&str, &[&str])] = &[
    ...
    (
        ...
        &[
            ...
            "ds_stats_after_drop/specs/ds_stats_after_drop_hit_",
            "ds_stats_after_drop/specs/ds_stats_after_drop_miss_",
            "ds_stats_after_rename/specs/ds_stats_after_rename_hit_",
            "ds_stats_after_rename/specs/ds_stats_after_rename_miss_",
            "ds_timestamp_microsecond/specs/ds_timestamp_microsecond_filter_",
            "ds_timestamp_microsecond/specs/ds_timestamp_microsecond_read_all",
            "ds_typed_stats/specs/ds_typed_stats_hit_",
            "ds_typed_stats/specs/ds_typed_stats_miss_",
    ...
    (
        ...
        &[
            ...
            "var_all_json_types/specs/var_all_json_types_read_all",
    ...
    (
        "Accepts checkpoint-only tables (no JSON commits)",
    ...
    (
        "Type widening metadata not preserved in nested struct fields (delta.typeChanges)",
