...
The built-in Parquet reader normalizes decimal and timestamp bounds using the source Parquet
scale and time unit. Bounds that cannot be converted safely remain unknown.
