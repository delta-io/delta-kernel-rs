...
CI timings are noisy and tend to run higher than on dedicated hardware, but proportional differences between branches are still a reliable signal for performance changes.
