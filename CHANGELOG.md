...
9. Provide expected stats schema ([#1592])
...
19. Change expected_stats_schema to return logical schema + physical schema ([#1749])
20. Add support for outputting parsed file statistics to scan batches ([#1720])
