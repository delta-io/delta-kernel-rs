...
- `src/schema.rs` -- kernel-to-engine schema traversal; UDT callbacks expose their physical type
  as a child and preserve string-or-null annotation members
- `src/schema_visitor.rs` -- engine-to-kernel schema construction
