...
commit_range_builder_for(path, start_version, engine)
  ...
  -> commit_range_builder_set_log_tail(builder, log_tail)         // optional catalog commits
  -> commit_range_builder_set_max_catalog_version(builder, max)   // required with staged commits
