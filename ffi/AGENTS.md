...
logical values with `write_context_builder_with_partition_values` or physical values with
`write_context_builder_with_physical_partition_values`; writers that provide materialized
