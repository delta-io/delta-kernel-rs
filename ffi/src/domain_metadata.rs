...
mod tests {
    ...
    async fn test_domain_metadata() -> DeltaResult<()> {
        ...
        assert_extern_result_error_with_message(res, KernelError::GenericError, Some("[DELTA_KERNEL_UNCLASSIFIED] User DomainMetadata are not allowed to use system-controlled 'delta.*' domain"));
