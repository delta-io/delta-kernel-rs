...
mod tests {
    ...
    mod column_default_ack_gate {
        ...
        use delta_kernel_ffi::expressions::{free_kernel_expression, SharedExpression};
        ...
        extern "C" fn ignore_default(
            ...
            // Owned handle: release it even though this gate test ignores the value.
            if let Some(handle) = default_expression {
        ...
        fn transaction_on(
            ...
            let table_root = Url::from_directory_path(path).unwrap().to_string();
