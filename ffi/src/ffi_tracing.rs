...
mod tests {
    ...
    extern "C" fn record_callback_impl(line: KernelStringSlice, expected_log_lines: Vec<&str>) {
    ...
    extern "C" fn event_callback_impl(event: Event, expected_log_lines: Vec<&str>) {
