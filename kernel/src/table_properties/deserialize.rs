...
fn try_parse(props: &mut TableProperties, k: &str, v: &str) -> Option<()> {
    use super::{
        APPEND_ONLY, AUTO_COMPACT, CHECKPOINT_INTERVAL, CHECKPOINT_POLICY,
        CHECKPOINT_WRITE_STATS_AS_JSON, CHECKPOINT_WRITE_STATS_AS_STRUCT, COLUMN_MAPPING_MODE,
        DATA_SKIPPING_NUM_INDEXED_COLS, DATA_SKIPPING_STATS_COLUMNS,
        DELETED_FILE_RETENTION_DURATION, ENABLE_CHANGE_DATA_FEED, ENABLE_DELETION_VECTORS,
        ...
        ISOLATION_LEVEL, LOG_RETENTION_DURATION, MATERIALIZED_ROW_COMMIT_VERSION_COLUMN_NAME,
        MATERIALIZED_ROW_ID_COLUMN_NAME, OPTIMIZE_WRITE, RANDOM_PREFIX_LENGTH,
        RANDOMIZE_FILE_PREFIXES, ROW_TRACKING_SUSPENDED, SET_TRANSACTION_RETENTION_DURATION,
        TARGET_FILE_SIZE, TUNE_FILE_SIZES_FOR_REWRITES,
    };
