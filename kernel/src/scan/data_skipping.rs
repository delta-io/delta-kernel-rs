...
impl DataSkippingFilter {
    ...
    pub(crate) fn new(
        ...
        let select_stats_evaluator = engine.expression_handler().new_expression_evaluator(
        ...
        let skipping_evaluator = engine.expression_handler().new_expression_evaluator(
            stats_schema.clone(),
