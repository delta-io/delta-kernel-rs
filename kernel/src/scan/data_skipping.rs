...
/// Transforms a min/max stats schema into a nullcount schema where all leaf fields are LONG.
...
impl DataSkippingFilter {
    ...
    /// * `physical_predicate` - The predicate and referenced schema for data skipping
