...
impl DataSkippingFilter {
    ...
    /// and the number of filtered rows for metrics tracking.
    pub(crate) fn apply(&self, batch: &dyn EngineData) -> DeltaResult<(Vec<bool>, u64)> {
        ...
        Ok((visitor.selection_vector, visitor.num_filtered))
    }
}
