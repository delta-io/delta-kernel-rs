...
use crate::schema::{
    schema_ref, ColumnNamesAndTypes, DataType, LogicalSchemaRef, MapType, SchemaRef,
...
mod tests {
    ...
    use crate::schema::{
        schema_ref, DataType, LogicalSchema, MetadataColumnSpec, SchemaRef, StructField, StructType,
    };
    ...
    fn test_serialization_preserves_stats_partition_schema_and_skip_stats() {
        ...
        assert!(
            deserialized.stats_options.skip_stats,
