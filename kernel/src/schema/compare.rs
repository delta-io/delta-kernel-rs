...
use super::{DataType, PrimitiveType, StructField, StructType};
...
impl SchemaComparison for DataType {
    ...
    fn can_read_as(&self, read_type: &Self) -> SchemaComparisonResult {
        match (self, read_type) {
            ...
            | (
                Self::Primitive(PrimitiveType::Short),
                Self::Primitive(PrimitiveType::Integer | PrimitiveType::Long),
            )
            | (Self::Primitive(PrimitiveType::Integer), Self::Primitive(PrimitiveType::Long)) => {}
            // Float type widening: float can be read as double
            (Self::Primitive(PrimitiveType::Float), Self::Primitive(PrimitiveType::Double)) => {}
