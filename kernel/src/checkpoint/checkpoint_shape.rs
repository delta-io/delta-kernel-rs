...
//! When structured metadata is requested, also reports whether the checkpoint has compatible
//! parsed stats and partition values.
...
impl CheckpointShape {
    ...
    /// the requested schemas are present, whether the checkpoint contains compatible parsed
