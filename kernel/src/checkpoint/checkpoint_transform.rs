...
///   [`expected_stats_schema`]. This schema has the following structure: ```ignore { numRecords:
///   long, nullCount: <nested struct with all leaf fields as long>, minValues: <nested struct
///   matching eligible column types>, maxValues: <nested struct matching eligible column types>, }
