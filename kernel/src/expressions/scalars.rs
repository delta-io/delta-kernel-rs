...
mod tests {
    ...
    fn test_arrays() {
        ...
        let array_op = Pred::binary(BinaryOperator::In, Expr::literal(10), array.clone());
        let array_not_op = Pred::binary(BinaryOperator::NotIn, Expr::literal(10), array);
        let column_op = Pred::binary(BinaryOperator::In, Expr::literal(PI), column.clone());
        let column_not_op = Pred::binary(BinaryOperator::NotIn, Expr::literal("Cool"), column);
