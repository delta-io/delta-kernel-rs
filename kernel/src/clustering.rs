...
//!
//! This module provides support for liquid clustering in Delta tables. Clustering
...
impl ClusteringMetadataDomain {
    ...
    /// Creates a new clustering metadata domain from column names with schema resolution.
    ///
    ...
    /// When column mapping is disabled (`none` mode), logical names are stored.
    ///
    /// # Arguments
    ///
