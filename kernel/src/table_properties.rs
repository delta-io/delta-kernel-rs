...
pub const AUTO_COMPACT: &str = "delta.autoOptimize.autoCompact";
pub const OPTIMIZE_WRITE: &str = "delta.autoOptimize.optimizeWrite";
...
pub const DATA_SKIPPING_STATS_COLUMNS: &str = "delta.dataSkippingStatsColumns";
...
pub const ENABLE_DELETION_VECTORS: &str = "delta.enableDeletionVectors";
pub const ENABLE_TYPE_WIDENING: &str = "delta.enableTypeWidening";
pub const ENABLE_ICEBERG_COMPAT_V1: &str = "delta.enableIcebergCompatV1";
pub const ENABLE_ICEBERG_COMPAT_V2: &str = "delta.enableIcebergCompatV2";
pub const ISOLATION_LEVEL: &str = "delta.isolationLevel";
pub const LOG_RETENTION_DURATION: &str = "delta.logRetentionDuration";
pub const ENABLE_EXPIRED_LOG_CLEANUP: &str = "delta.enableExpiredLogCleanup";
...
pub const CHECKPOINT_POLICY: &str = "delta.checkpointPolicy";
pub const ENABLE_ROW_TRACKING: &str = "delta.enableRowTracking";
pub const MATERIALIZED_ROW_ID_COLUMN_NAME: &str = "delta.rowTracking.materializedRowIdColumnName";
pub const MATERIALIZED_ROW_COMMIT_VERSION_COLUMN_NAME: &str = "delta.rowTracking.materializedRowCommitVersionColumnName";
pub const ROW_TRACKING_SUSPENDED: &str = "delta.rowTrackingSuspended";
pub const ENABLE_IN_COMMIT_TIMESTAMPS: &str = "delta.enableInCommitTimestamps";
pub const IN_COMMIT_TIMESTAMP_ENABLEMENT_VERSION: &str = "delta.inCommitTimestampEnablementVersion";
pub const IN_COMMIT_TIMESTAMP_ENABLEMENT_TIMESTAMP: &str = "delta.inCommitTimestampEnablementTimestamp";
