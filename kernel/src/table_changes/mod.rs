...
pub(crate) static CHANGE_TYPE_COL_NAME: &str = "_change_type";
pub(crate) static COMMIT_VERSION_COL_NAME: &str = "_commit_version";
pub(crate) static COMMIT_TIMESTAMP_COL_NAME: &str = "_commit_timestamp";
