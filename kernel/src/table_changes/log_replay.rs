...
/// [process_cdf_commit] in order to detect errors and fail early.
///
...
/// Generates an iterator of [`TableChangesScanData`] by consuming a [`ProcessedCdfCommit`] and iterating
