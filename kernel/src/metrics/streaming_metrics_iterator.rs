...
impl<I, E> Iterator for MetricsIterator<I, FileMeta>
where
    I: Iterator<Item = Result<FileMeta, E>>,
{
    type Item = I::Item;
...
impl<I, E> Iterator for MetricsIterator<I, Bytes>
where
    I: Iterator<Item = Result<Bytes, E>>,
{
    type Item = I::Item;
