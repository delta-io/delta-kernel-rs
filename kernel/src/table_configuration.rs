...
impl TableConfiguration {
    ...
    /// Creates a new [`TableConfiguration`] by cloning an existing one at a new version.
    /// All fields (metadata, protocol, schema, properties) are carried forward unchanged.
