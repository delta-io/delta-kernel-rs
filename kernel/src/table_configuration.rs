    ...
    fn write_with_cdf() {
        ...
        let cases = [
            ...
            (
                ...
                Err(Error::unsupported(r#"Found unsupported TableFeatures: "columnMapping". Supported TableFeatures: "changeDataFeed", "appendOnly", "deletionVectors", "domainMetadata", "inCommitTimestamp", "invariants", "materializePartitionColumns", "rowTracking", "timestampNtz", "variantType", "variantType-preview", "variantShredding-preview""#)),
            ),
            (
