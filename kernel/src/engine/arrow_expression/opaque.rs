...
use crate::expressions::{Expression, OpaqueExpressionOp, OpaquePredicateOp, Predicate, Scalar};
...
impl OpaquePredicateOp for ArrowOpaquePredicateOpAdaptor {
    ...
    fn eval_pred_scalar(
        ...
        (**self).eval_pred_scalar(values, inverted)
    }
