...
//! - [`identity_column_cic`]: stamps the CIC metadata onto a schema field at CREATE-table time

use crate::schema::{ColumnMetadataKey, DataType, MetadataValue, SchemaRef, StructField};
