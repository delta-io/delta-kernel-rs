...
impl<S> Transaction<S> {
    ...
    fn into_committed(
        ...
        let txn_changes = txn_changes::TxnChangesContext {
            parsed_commit,
            in_commit_timestamp,
        };
        ...
        Ok(CommittedTransaction {
            commit_version,
            post_commit_stats,
            post_commit_snapshot: Some(Arc::new(self.read_snapshot.new_post_commit(txn_changes)?)),
        })
    }
