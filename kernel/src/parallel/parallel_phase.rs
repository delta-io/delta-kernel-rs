...
#[internal_api]
#[allow(unused)]
pub(crate) struct ParallelPhase<P: ParallelizableLogReplayProcessor> {
    processor: Arc<P>,
    leaf_checkpoint_reader: CheckpointLeafReader,
}

impl<P: ParallelizableLogReplayProcessor> ParallelPhase<P> {
...
impl<P: ParallelizableLogReplayProcessor> Iterator for ParallelPhase<P> {
