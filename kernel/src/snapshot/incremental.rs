...
impl Snapshot {
    ...
    pub(super) fn try_new_from(
        ...
        let new_checkpoint_hint = new_log_segment.last_checkpoint_hint();
        ...
        // new_log_segment.last_checkpoint_hint() is always None when a new checkpoint
        ...
        let (new_checkpoint_parts, new_checkpoint_schema) = if new_checkpoint_version.is_some() {
            ...
            (
                ...
                existing_log_segment.last_checkpoint_hint(),
            )
        };
