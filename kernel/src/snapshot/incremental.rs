//! Incremental [`Snapshot`] update from an existing snapshot.
//!
//! Implements the state machine that powers [`SnapshotBuilder::build`] when called via
//! [`Snapshot::builder_from`]. See [`Snapshot::try_new_from`] for the case breakdown.
//!
//! [`SnapshotBuilder::build`]: crate::snapshot::SnapshotBuilder::build
//! [`Snapshot::builder_from`]: crate::snapshot::Snapshot::builder_from
