...
/// Recognizes all checkpoint filename variants (V1 single-part, V1 multi-part, V2 classic-named,
/// V2 UUID-named) via [`ParsedLogPath`].
pub fn load_checkpoint_path(table_path: &str, version: u64) -> std::path::PathBuf {
